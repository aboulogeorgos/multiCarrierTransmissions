...
function [ rt,yOFDMsymbol,yt,yFbeforeEqualizer,yF,yMod,ipModHat,ipBitHat ] = Rx( ht,hF,xtPlusCP,nSym,nBitPerSym,nDSC,nFFT,nTap,EsN0dB )
    ...
    [ yMod ] = removeVirtualSubcarriers( nBitPerSym,yF );
